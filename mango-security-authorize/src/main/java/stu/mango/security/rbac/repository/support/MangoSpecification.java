...
public abstract class MangoSpecification<T, C> extends AbstractEventConditionBuilder<T, C>
		implements Specification<T> {

	/**
	 * @param condition
	 */
	public MangoSpecification(C condition) {
		super(condition);
	}
	...
	/**
	 * 添加权限条件，如果要查询的domain实现了ManagedByOrgan接口，那么传入的Condition对象也应该实现
	 ManagedByOrgan接口，
